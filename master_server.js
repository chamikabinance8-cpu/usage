// master_server.js (Run on Port 4000)
...
app.get('/get-ui', (req, res) => {
    // මෙන්න මෙතනින් තමයි ලස්සන UI එක Users ලට යන්නේ
    const latestUI = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body class="bg-[#0b0f1a] text-white p-4 md:p-8">
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
                ...
                <button onclick="location.reload()" class="bg-slate-800 hover:bg-slate-700 text-gray-300 px-6 py-2 rounded-xl text-sm font-bold border border-slate-700 transition">Refresh Dashboard</button>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-slate-900/50 p-6 rounded-3xl border border-slate-800 shadow-xl">
                    ...
                    <div class="w-full bg-slate-950 h-1.5 rounded-full mb-4">
                        <div id="cpu-bar" class="h-1.5 rounded-full bg-blue-500 transition-all duration-500" style="width: 0%"></div>
                    </div>
                    <p id="cpu-cores" class="text-gray-500 text-xs">-</p>
                </div>
                ...
                <div class="bg-slate-900/50 p-6 rounded-3xl border border-slate-800 shadow-xl">
                    ...
                    <div class="w-full bg-slate-950 h-1.5 rounded-full mb-4">
                        <div id="ram-bar" class="h-1.5 rounded-full bg-purple-500 transition-all duration-500" style="width: 0%"></div>
                    </div>
                    <p id="ram-total" class="text-gray-500 text-xs">-</p>
                </div>
                ...
                <div class="bg-slate-900/50 p-6 rounded-3xl border border-slate-800 shadow-xl lg:col-span-2">
                    ...
                    <div class="w-full bg-slate-950 h-1.5 rounded-full mb-4">
                        <div id="disk-bar" class="h-1.5 rounded-full bg-emerald-500 transition-all duration-500" style="width: 0%"></div>
                    </div>
                ...
                <div class="bg-slate-900/50 p-6 rounded-3xl border border-slate-800 shadow-xl md:col-span-4 grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="border-r border-slate-800 pr-4">
                        ...
                        <p id="vps-os" class="font-bold text-sm text-blue-400 truncate">-</p>
                    </div>
                    <div class="border-r border-slate-800 pr-4">
                        <p class="text-gray-500 text-[10px] uppercase font-bold mb-1">Hostname</p>
                        <p id="vps-host" class="font-bold text-sm text-white truncate">-</p>
                    </div>
                    <div class="border-r border-slate-800 pr-4">
...
app.listen(4000, () => console.log('Master UI Server live on port 4000'));
